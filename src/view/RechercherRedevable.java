 ...
 * @author simob
 */
public class RechercherRedevable extends javax.swing.JFrame {
    RedevableHelper redevableHelper;
    List<Redevable>resRed=new ArrayList();
    RedevableService redevableService=new RedevableService();
    /**
     * Creates new form RechercherRedevable
     */
    public RechercherRedevable() {
        initComponents();
        initHelper();
    }
...
public Redevable getParam(){
    ...
    private void jTable1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTable1MouseClicked
        ...
        new Res_Ter_Red().setVisible(true);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(RechercherRedevable.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
