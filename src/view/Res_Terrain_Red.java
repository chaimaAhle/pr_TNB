 ...
 * @author Aniela
 */
public class Res_Terrain_Red extends javax.swing.JFrame {
    TerrainHelper terrainHelper;
    RedevableService redevableService=new RedevableService();
    TerrainService terrainService=new TerrainService();
    /**
     * Creates new form res_Terrain
     */
    public Res_Terrain_Red() {
        initComponents();
        initHelper();
    }
public void initHelper(){
  terrainHelper=new TerrainHelper(jTable1,
  terrainService.findByRedevable((Redevable) Session.getAttribut("owner")));
}
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Terrain du redevable");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Res_Terrain_Red.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
