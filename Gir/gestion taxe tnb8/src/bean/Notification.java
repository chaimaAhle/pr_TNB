...
public class Notification implements Serializable {
    ...
    public Notification(Long id, float montantEstimé, int année) {
        this.id = id;
        this.montantEstimé = montantEstimé;
        this.année = année;
    }
    ...
    public float getMontantEstimé() {
        return montantEstimé;
    }

    public void setMontantEstimé(float montantEstimé) {
        this.montantEstimé = montantEstimé;
    }
    ...
    public Date getDateRéception() {
        if(dateRéception==null){
            Date dateRéception= new Date();
        }
        return dateRéception;
    }

    public void setDateRéception(Date dateRéception) {
        this.dateRéception = dateRéception;
    }
    ...
    public String toString() {
        return "Notification{" + "id=" + id + ", montantEstim\u00e9=" + montantEstimé + ", ann\u00e9e=" + année + '}';
    }
